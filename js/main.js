...
function showPokemon(poke) {
    ...
    if (pokeHeight.length === 1) {
        pokeHeight = "0," + pokeHeight;
    } else if (pokeHeight.length === 2) {
        pokeHeight = pokeHeight[0] + "," + pokeHeight[1];
    }
    let pokeWeight = poke.weight.toString();
    if (pokeWeight.length === 2) {
        pokeWeight = pokeWeight[0] + "," + pokeWeight[1];
    } else if (pokeWeight.length === 3) {
        pokeWeight = pokeWeight[0] + pokeWeight[1] + "," + pokeWeight[2];
    } else if (pokeWeight.length === 4) {
